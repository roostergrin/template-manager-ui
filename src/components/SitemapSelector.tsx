...
export type SitemapSelectorProps = {
...
const SitemapSelector: React.FC<SitemapSelectorProps> = ({ onSelectSitemap }) => {
  ...
  return (
    <div className="flex flex-col gap-2 mb-4">
      <label htmlFor="sitemap-selector" className="text-gray-700 font-medium">
